...
description: Generate high-quality, predictable, and efficient skills for the Antigravity agent environment. Use when user need to create a new skill or defining new agent capability.
---
