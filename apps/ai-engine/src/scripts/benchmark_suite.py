...
def _hardware_metrics(report: ProfileReport | None) -> dict[str, Any] | None:
    ...
    return {
        ...
        "configured_device": report.configured_device,
        ...
        "avg_process_cpu": report.avg_process_cpu,
        "max_process_cpu": report.max_process_cpu,
        "avg_process_rss_gb": report.avg_process_rss_gb,
        "max_process_rss_gb": report.max_process_rss_gb,
        "max_process_thread_count": report.max_process_thread_count,
        "max_process_child_count": report.max_process_child_count,
